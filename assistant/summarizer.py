...
def crawl(target_dir: str) -> tuple[str, dict[str, str]]:
    ...
    def _crawl_directory(directory: str, current_depth: int = 0) -> None:
        # Limit depth to 2 folders away from target_dir
        if current_depth > 2:
            return
        ...
        with os.scandir(directory) as entries:
            for entry in entries:
                if entry.is_dir():
                    ...
                    _crawl_directory(entry.path, current_depth + 1)  # Recurse into subdirectory
